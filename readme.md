...
- Localization, support multiple languages [en, zh-CN, zh-TW, es-ES, fr, ru, de, ko]
...
- **language** `String`
  ...
  Localization language key, `en`, `zh-CN`, `zh-TW`, `es-ES`, `fr`, `ru`, `de` and `ko` are currently available.
